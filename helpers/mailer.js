...
const baseUrl = 'https://obabuzz.netlify.app';
...
signup: async (receiver, username ) => {
      ...
      const html =  `
        <h2>Welcome to Buzz</h2>
          ...
          <p><a href='https://obabuzz.netlify.app/verify/${username}'>Activate your account</a> to receive notifications</p>
          <p>Welcome on board</p>
          The <a href='https://obabuzz.netlify.app/twits'>Buzz</a> Team`;
...
follow: async (receiver, username, follower) => {
      ...
      const html =  `
        <h2>Hey!, <a href='https://obabuzz.netlify.app/${follower}'>${follower}</a> just followed you on Buzz</h2>
          ...
          <p><a href='https://obabuzz.netlify.app/${username}'>View your profile</a></p>
          The <a href='https://obabuzz.netlify.app/twits'>Buzz</a> Team`;
...
like: async (receiver, twitId, likingUser) => {
  console.log(receiver, twitId, likingUser)
      ...
      const html =  `
        <h2>Hey!, <a href='https://obabuzz.netlify.app/${likingUser}'>${likingUser}</a> just liked your post on Buzz</h2>
          <p>Just like we told you, this is getting exciting and you are getting noticed.</p>
          <p>The social media space in Africa connects millions of like-minded individuals and organizations with potentially great opportunities.</p>
          <p>You can post, view and search users, also follow and unfollow users.</p>
          <p>We promise more features as we build out this great community</p>
          <p><a href='https://obabuzz.netlify.app/twits/#${twitId}'>View your liked post</a></p>
          The <a href='https://obabuzz.netlify.app/twits'>Buzz</a> Team`;
...
comment: async (receiver, twitId, commentingUser) => {
  console.log(receiver, twitId, commentingUser)
      ...
      const html =  `
        <h2>Hey!, <a href='https://obabuzz.netlify.app/${commentingUser}'>${commentingUser}</a> just commented on your post on Buzz</h2>
          <p>Just like we told you, this is getting exciting and you are getting noticed.</p>
          <p>The social media space in Africa connects millions of like-minded individuals and organizations with potentially great opportunities.</p>
          <p>You can post, view and search users, also follow and unfollow users.</p>
          <p>We promise more features as we build out this great community</p>
          <p><a href='https://obabuzz.netlify.app/twits/#${twitId}'>View your post</a></p>
          The <a href='https://obabuzz.netlify.app/twits'>Buzz</a> Team`;
...
likecomment: async (receiver, commentId, commentLikeUser) => {
  console.log(receiver, commentId, commentingUser)
      ...
      const html =  `
        <h2>Hey!, <a href='https://obabuzz.netlify.app/${commentLikeUser}'>${commentLikeUser}</a> just liked your comment on Buzz</h2>
          <p>Just like we told you, this is getting exciting and you are getting noticed.</p>
          <p>The social media space in Africa connects millions of like-minded individuals and organizations with potentially great opportunities.</p>
          <p>You can post, view and search users, also follow and unfollow users.</p>
          <p>We promise more features as we build out this great community</p>
          <p><a href='https://obabuzz.netlify.app/twits/#${commentId}'>View your comment</a></p>
          The <a href='https://obabuzz.netlify.app/twits'>Buzz</a> Team`;
